...
> 修复之后带有【专家】和【混乱】的项目都会一定程度上变难，然而修复时旧的成绩并没有被删除
...
> 注：只带【专家】到3层时，因为0.05*3==0.15000000000000002，所以`垃圾集中`会被关闭
...
- 重力显著增加
- 每层的锁定延迟表（单位 帧）： 30, 29, 28, 27, 26, 24, 22, 20, 18, 16
...
- 从一开局起就20G（每层的锁定延迟：24，22，20，18，16，15，14，13，12，11）
